...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Function to load and display the visualization
    function loadVisualization() {
        ...
        } //Closes the filterAndUpdateChart function
        ...
        function createBarChart(data, metric) {
            ...
            // Add the metric label (e.g., "Alcohol", "pH")
            svg.append("text")
        ...
        } //Closes the createBarChart function
    ...
    // Define the gradient for the legend
        ...
        legend.append("text")
          ...
          .text("High");
        } // <-- Close the addColorLegend function here
